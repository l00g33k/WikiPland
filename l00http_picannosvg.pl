...
sub l00http_picannosvg_proc (\%) {
            ...
            if (($waypts eq $lsttrkname) &&
                ...
                while (1) {
                    ...
                    while ($_ = &l00httpd::l00freadLine($ctrl)) {
                        if (($lnno % 10000) == 9999) {
                            print "picannosvg trk: ", int($lnno / 10000), "0,000\n";
                        }
                        $lnno++;
                        s/\n//g;
                        s/\r//g;
    ...
    print $sock "<a href=\"/picannosvg.htm?path=$path\">Refresh</a> - \n";
    ...
    print $sock "            <td><input type=\"text\" size=\"16\" name=\"atx\" value=\"$form->{'x'}\"></td>\n";
    print $sock "        </tr>\n";
                                                
    print $sock "        <tr>\n";
    print $sock "            <td>lat:</td>\n";
    print $sock "            <td><input type=\"text\" size=\"16\" name=\"aty\" value=\"$form->{'y'}\"></td>\n";
    print $sock "        </tr>\n";
