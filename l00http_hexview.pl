...
sub l00http_hexview_proc {
    ...
    print $sock "0x<input type=\"text\" name=\"offset\" size=8 value=\"$tmp\" accesskey=\"o\">\n";
    print $sock "</td></tr>\n";
    print $sock "<tr><td>\n";
    print $sock "L&#818;ength\n";
    print $sock "</td><td>\n";
    $tmp = sprintf ("%x", $length);;
    print $sock "0x<input type=\"text\" name=\"length\" size=8 value=\"$tmp\" accesskey=\"l\">\n";
    print $sock "</td></tr>\n";
    print $sock "<tr><td>\n";
    print $sock "W&#818;idth\n";
    print $sock "</td><td>\n";
    print $sock "<input type=\"text\" name=\"width\" size=8 value=\"$width\" accesskey=\"w\">\n";
    print $sock "</td></tr>\n";
    print $sock "<tr><td>\n";
    print $sock "G&#818;roup\n";
    print $sock "</td><td>\n";
    print $sock "<input type=\"text\" name=\"group\" size=8 value=\"$group\" accesskey=\"g\">\n";
    print $sock "</td></tr>\n";
    print $sock "<tr><td>\n";
    print $sock "Show\n";
    print $sock "</td><td>\n";
